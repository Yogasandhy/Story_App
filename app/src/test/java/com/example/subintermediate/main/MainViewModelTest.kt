...
import com.example.subintermediate.DataDummy
import com.example.subintermediate.LiveDataTestUtil.getOrAwaitValue
import com.example.subintermediate.MainDispatcherRule
...
class MainViewModelTest {
    ...
    @Test
    fun `when Get Stories Should Not Null and Return Data`(): Unit = runTest {
    ...
    @Test
    fun `when Get Stories Empty Should Return No Data`(): Unit = runTest {
